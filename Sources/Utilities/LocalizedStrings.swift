...
/// Centralized localized strings for VoiceFlow
internal enum LocalizedStrings {
    ...
    enum Alerts {
        ...
        static let microphoneAccessMessage = NSLocalizedString("alerts.microphone_access_message", 
            value: "VoiceFlow needs microphone access to record audio. Please enable microphone access in System Settings > Privacy & Security > Microphone.", 
